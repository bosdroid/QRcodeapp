...
class ListValueAdapter(val context: Context, val listItems: ArrayList<ListItem>) :
    RecyclerView.Adapter<ListValueAdapter.ItemViewHolder>() {
...
//                val viewHolder = holder as ItemViewHolder
        holder.listValueView.text = listValue.value
