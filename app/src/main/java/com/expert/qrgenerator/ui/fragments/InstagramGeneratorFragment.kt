...
import com.expert.qrgenerator.databinding.FragmentInstagramGeneratorBinding
...
class InstagramGeneratorFragment : Fragment() {

    // ViewBinding instance to access the layout's views
    private lateinit var binding: FragmentInstagramGeneratorBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentInstagramGeneratorBinding.inflate(inflater, container, false)
