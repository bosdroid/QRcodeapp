...
import com.expert.qrgenerator.databinding.FragmentWifiGeneratorBinding
...
class WifiGeneratorFragment : Fragment() {

    // ViewBinding instance for accessing the fragment's layout views
    private lateinit var binding: FragmentWifiGeneratorBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentWifiGeneratorBinding.inflate(inflater, container, false)
