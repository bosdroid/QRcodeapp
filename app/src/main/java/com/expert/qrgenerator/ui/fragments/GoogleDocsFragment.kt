...
import com.expert.qrgenerator.databinding.FragmentGoogleDocsBinding
...
class GoogleDocsFragment : Fragment() {

    private lateinit var binding:FragmentGoogleDocsBinding
    ...
    override fun onCreateView(
        ...
        binding =  FragmentGoogleDocsBinding.inflate(inflater, container, false)
        ...
        binding.nextStepBtn.setOnClickListener {
            ...
            // If all validations pass, encode the data and generate a QR code
                ...
                encodedData = value
                GeneratorManager.generateQRCode(requireActivity(), encodedData, "google-docs")
            }
        }
