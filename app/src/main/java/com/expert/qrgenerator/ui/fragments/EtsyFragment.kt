...
import com.expert.qrgenerator.databinding.FragmentEtsyBinding
...
class EtsyFragment : Fragment() {

    private lateinit var binding:FragmentEtsyBinding
    ...
    override fun onCreateView(
        ...
        binding =  FragmentEtsyBinding.inflate(inflater, container, false)
        ...
        binding.nextStepBtn.setOnClickListener {
            ...
            // If all validations pass, encode the data and generate a QR code
                ...
                encodedData = value
                GeneratorManager.generateQRCode(requireActivity(), encodedData, "etsy")
            }
        }
