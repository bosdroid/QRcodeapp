...
import com.expert.qrgenerator.databinding.FragmentGoogleSheetsBinding
...
class GoogleSheetsFragment : Fragment() {
    ...
    private lateinit var binding:FragmentGoogleSheetsBinding
    ...
    override fun onCreateView(
        ...
        binding =  FragmentGoogleSheetsBinding.inflate(inflater, container, false)
        ...
        binding.nextStepBtn.setOnClickListener {
            ...
            // If all validations pass, encode the data and generate a QR code
                ...
                encodedData = value
                GeneratorManager.generateQRCode(requireActivity(), encodedData, "google-sheets")
            }
        }
