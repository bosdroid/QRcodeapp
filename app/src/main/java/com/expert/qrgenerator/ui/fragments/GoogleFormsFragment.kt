...
import com.expert.qrgenerator.databinding.FragmentGoogleFormsBinding
...
@AndroidEntryPoint
class GoogleFormsFragment : Fragment() {

    private lateinit var binding:FragmentGoogleFormsBinding
    ...
    override fun onCreateView(
        ...
        binding =  FragmentGoogleFormsBinding.inflate(inflater, container, false)
        ...
        binding.nextStepBtn.setOnClickListener {
            ...
            // If all validations pass, encode the data and generate a QR code
                ...
                encodedData = value
                GeneratorManager.generateQRCode(requireActivity(), encodedData, "google-forms")
            }
        }
