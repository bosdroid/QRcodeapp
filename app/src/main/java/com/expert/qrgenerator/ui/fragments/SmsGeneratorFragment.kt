...
import com.expert.qrgenerator.databinding.FragmentSmsGeneratorBinding
...
class SmsGeneratorFragment : Fragment() {

    // Late initialization for the view binding
    private lateinit var binding: FragmentSmsGeneratorBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentSmsGeneratorBinding.inflate(inflater, container, false)
