...
import com.expert.qrgenerator.databinding.FragmentLinkdinBinding
...
class LinkedinFragment : Fragment() {
    ...
    private lateinit var binding:FragmentLinkdinBinding
    ...
    override fun onCreateView(
        ...
        binding =  FragmentLinkdinBinding.inflate(inflater, container, false)
        ...
        binding.nextStepBtn.setOnClickListener {
            ...
            // If all validations pass, encode the data and generate a QR code
                ...
                encodedData = value
                GeneratorManager.generateQRCode(requireActivity(), encodedData, "linkedin")
            }
        }
