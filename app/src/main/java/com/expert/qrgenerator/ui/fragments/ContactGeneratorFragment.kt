...
import com.expert.qrgenerator.databinding.FragmentContactGeneratorBinding
...
class ContactGeneratorFragment : Fragment() {

    // Binding object for the fragment's layout
    private lateinit var binding: FragmentContactGeneratorBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentContactGeneratorBinding.inflate(inflater, container, false)
