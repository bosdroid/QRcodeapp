...
class DesignActivity : BaseActivity(), View.OnClickListener {
    ...
    private fun renderBackgroundImageRecyclerview() {
        ...
        viewModel.backgroundImageList.observe(this, { list ->
            if (list != null) {
...
//                    isBackgroundSet = qrImage != null
    ...
    private fun renderColorsRecyclerview() {
        ...
        viewModel.colorList.observe(this, { colors ->
            if (colors != null) {
    ...
    private fun renderLogoImagesRecyclerview() {
        ...
        viewModel.logoImageList.observe(this, { list ->
            if (list != null) {
    ...
    private fun renderFontRecyclerview() {
        ...
        viewModel.fontList.observe(this, { list ->
            if (list != null) {
                if (fontList.size > 0) {
                    fontList.clear()
                }
