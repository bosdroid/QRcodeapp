...
import com.expert.qrgenerator.databinding.FragmentSnapchatBinding
...
class SnapchatFragment : Fragment() {
    ...
    private lateinit var binding:FragmentSnapchatBinding
    ...
    override fun onCreateView(
        ...
        binding =  FragmentSnapchatBinding.inflate(inflater, container, false)
        ...
        binding.nextStepBtn.setOnClickListener {
            ...
            // If all validations pass, encode the data and generate a QR code
                ...
                encodedData = value
                GeneratorManager.generateQRCode(requireActivity(), encodedData, "snapchat")
            }
        }
