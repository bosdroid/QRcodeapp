...
import com.expert.qrgenerator.databinding.FragmentShapedBinding
...
@AndroidEntryPoint
class ShapedFragment : Fragment() {

    private lateinit var binding:FragmentShapedBinding
    ...
    override fun onCreateView(
        ...
        binding =  FragmentShapedBinding.inflate(inflater, container, false)
        ...
        binding.nextStepBtn.setOnClickListener {
            ...
            // If all validations pass, encode the data and generate a QR code
                ...
                encodedData = value
                GeneratorManager.generateQRCode(requireActivity(), encodedData, "shaped")
            }
        }
