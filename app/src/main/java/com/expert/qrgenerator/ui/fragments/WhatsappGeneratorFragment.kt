...
import com.expert.qrgenerator.databinding.FragmentWhatsappGeneratorBinding
...
class WhatsappGeneratorFragment : Fragment() {

    // ViewBinding for accessing UI components
    private lateinit var binding: FragmentWhatsappGeneratorBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentWhatsappGeneratorBinding.inflate(inflater, container, false)
