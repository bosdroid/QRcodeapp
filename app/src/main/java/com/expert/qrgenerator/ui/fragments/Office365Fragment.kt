...
import com.expert.qrgenerator.databinding.FragmentOffice365Binding
...
class Office365Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding =  FragmentOffice365Binding.inflate(inflater, container, false)
        ...
        binding.nextStepBtn.setOnClickListener {
            ...
            // If all validations pass, encode the data and generate a QR code
                ...
                encodedData = value
                GeneratorManager.generateQRCode(requireActivity(), encodedData, "office-365")
            }
        }
